namespace CAS.EntityModel.Models
{
    ...
    [Table("OffRoadLocationType")]
    public partial class OffRoadLocationType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public OffRoadLocationType()
        {
        ...
        [StringLength(50)]
        public string offRoadLocationTypeName { get; set; }

        [StringLength(100)]
        public string offRoadLocationTypeCode { get; set; }

        [StringLength(1000)]
        public string offRoadLocationTypeDescription { get; set; }
