namespace CAS.EntityModel.Models
{
    ...
    [Table("RailCrossingTypeType")]
    public partial class RailCrossingTypeType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public RailCrossingTypeType()
        {
        ...
        [StringLength(50)]
        public string railCrossingTypeTypeName { get; set; }

        [StringLength(100)]
        public string railCrossingTypeTypeCode { get; set; }

        [StringLength(1000)]
        public string railCrossingTypeTypeDescription { get; set; }
