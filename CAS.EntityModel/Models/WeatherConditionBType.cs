namespace CAS.EntityModel.Models
{
    ...
    [Table("WeatherConditionBType")]
    public partial class WeatherConditionBType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public WeatherConditionBType()
        {
        ...
        [StringLength(50)]
        public string weatherConditionBTypeName { get; set; }

        [StringLength(100)]
        public string weatherConditionBTypeCode { get; set; }

        [StringLength(1000)]
        public string weatherConditionBTypeDescription { get; set; }
