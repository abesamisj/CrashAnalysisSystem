namespace CAS.EntityModel.Models
{
    ...
    [Table("DrugTypeType")]
    public partial class DrugTypeType
    {
        ...
        [StringLength(50)]
        public string drugTypeTypeName { get; set; }

        [StringLength(100)]
        public string drugTypeTypeCode { get; set; }

        [StringLength(1000)]
        public string drugTypeTypeDescription { get; set; }
