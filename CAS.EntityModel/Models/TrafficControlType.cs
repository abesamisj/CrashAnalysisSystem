namespace CAS.EntityModel.Models
{
    ...
    [Table("TrafficControlType")]
    public partial class TrafficControlType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public TrafficControlType()
        {
        ...
        [StringLength(50)]
        public string trafficControlTypeName { get; set; }

        [StringLength(100)]
        public string trafficControlTypeCode { get; set; }

        [StringLength(1000)]
        public string trafficControlTypeDescription { get; set; }
