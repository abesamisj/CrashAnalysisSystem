namespace CAS.EntityModel.Models
{
    ...
    [Table("JunctionTypeType")]
    public partial class JunctionTypeType
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public JunctionTypeType()
        {
        ...
        [StringLength(50)]
        public string junctionTypeTypeName { get; set; }

        [StringLength(100)]
        public string junctionTypeTypeCode { get; set; }

        [StringLength(1000)]
        public string junctionTypeTypeDescription { get; set; }
